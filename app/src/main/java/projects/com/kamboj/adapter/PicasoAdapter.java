...
public class PicasoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<StudentModel> mList;
    private Context mContext;

    public PicasoAdapter(Context context, List<StudentModel> studentModels) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.picso, parent, false);
